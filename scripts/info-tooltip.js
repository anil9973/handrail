import { AiAssistantDialog } from "./input-assistant/response-dialog.js";
...
export class InfoTooltip extends HTMLElement {
	...
	openAiAssistantDialog() {
		const aiAssistantDialog = new AiAssistantDialog();
		this.appendChild(aiAssistantDialog);
	}
	...
	connectedCallback() {
		...
		this.firstElementChild.addEventListener("click", this.openAiAssistantDialog);
	}
}
